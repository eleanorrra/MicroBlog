...
def index():
    ...
    posts = current_user.related_posts().order_by(Post.timestamp.desc()).paginate(page, app.config['POSTS_PER_PAGE'],
                                                                                  False)
...
def reset_password_request():
    ...
    return render_template('pages/reset_password_request.html', form=form)
